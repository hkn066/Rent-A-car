...
@RestControllerAdvice // Bütün controller çalışırken ExceptionHandler a tabidir buradan geçmelidir.
public class RentACarApplication {
	//Aop (Aspec Oriented Programing)
	...
	public ValidationProblemDetails handleValidationException(MethodArgumentNotValidException argumentNotValidException) {
		...
		validationproblemDetails.setMessage(argumentNotValidException.getMessage());
